package com.inputstream.bytetochar;
...
public class BinaryToCharConverter {
    ...
    public static void main(String[] args) {
        String filename = "A:\\Bridgelab\\Week3\\Day04-DataStructure\\collection\\src\\main\\java\\com\\inputstream\\bytetochar\\example.txt"; // Update file path
